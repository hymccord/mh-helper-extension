...
import {parseJournalEntries} from "./parseJournalEntries";
...
(function () {
    ...
    function recordHuntWithPrehuntUser(pre_response, post_response) {
        ...
        const hunt = parseJournalEntries(pre_response, post_response,
            userSettings, logger, submitMainIntakeMessage, submitItemConvertible);
